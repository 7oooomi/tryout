...
test('Q2', getNgram(str, 1), ["今", "日", "の", "晩", "御", "飯", "は", "カ", "レ", "ー", "だ", "。"]);
test('Q2', getNgram(str, 2), ["今日", "日の", "の晩", "晩御", "御飯", "飯は", "はカ", "カレ", "レー", "ーだ", "だ。"]);
test('Q2', getNgram(str2, 3), ["明日の", "日の朝", "の朝は", "朝は早", "は早い"]);
...
test('Q3', objectMap(obj, addFive), { Tanaka: 65, Yamada: 77, Takahashi: 54, Hisoka: 100 });
test('Q3', objectMap(obj, toUpperLetters), { TANAKA: 60, YAMADA: 72, TAKAHASHI: 49, HISOKA: 95 });
